...
![OSI 7 Layer with TCP/IP 4 Layer](/assets/layer.jpg)
...
![TCP/IP 4 Layer Protocol](/assets/layer_protocol.png)
...
![HTML/Javascript/CSS](https://jkkim09.github.io/assets/images//posts/front-end/top.jpg)

이외에도 Database Server, Web Server, Distribution Server등 인터넷의 발전에 따라 네트워크를 이용한 많은 형태의 서비스와 개발 툴이 등장하고 있다.

![Backend Roadmap](/assets/backend_roadmap.png)
*[출처][3]*
...
![Network Socket](/assets/network_socket.png)
*Network Socket*
